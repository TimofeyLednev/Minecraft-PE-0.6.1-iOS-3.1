/*
 * GLES/gl.h -- OpenGL ES 1.1 / EGL for Windows Mobile (Windows CE, ARM)
 *
 ...
 *   - GL_APIENTRY is empty: ARM has one calling convention, so
...
#define GL_APIENTRY
#endif
/* Some sources spell these the desktop way. */
#ifndef GLAPI
#define GLAPI       GL_API
#endif
#ifndef APIENTRY
...
/* ---- entry points (145 of 145 present in libGLES_CM.dll) ---- */
